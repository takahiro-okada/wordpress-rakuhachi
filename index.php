...
<body class="drawer drawer--left">
      ...
      <div class="news-content">
        <div class="news-content__inner">
          ...
          <p class="news-header__text">
            録画配信は、17日(土)13時〜18日(日)17時までの配信になります。
          </p>
        </div>
      </div>
    </div>
      ...
      <ul class="event__list">
        ...
        <li class="event__item">
          ...
          <div class="util__button _event">
            <span href="" class="util__button-link _event" >個別相談は終了しました</span>
          </div>
        </li>
  ...
  <section class="schedule" id="schedule">
    ...
    <div class="news-date">
      <p class="news-date__text">録画配信は、17日(土)13時〜18日(日)17時までの配信になります。</p>
    </div>
